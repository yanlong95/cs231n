...
tags = ['apartments','church','house','industrial','office','retail','roof','warehouse']
# tags = ['church', 'office', 'industrial', 'warehouse']
location_name = 'boston'

with tqdm(total=len(tags)) as t:
    for tag in tags:
        csv_filename = 'centroid_csv_file/' + location_name + '-' + tag + '.csv'
        ...
        print('...waiting for response from Street Map Static API...')
        results = gsvapi.results(street_view_list)
        
        # Download images to directory 'downloads'
        # results.preview()
        print('...saving images...')
        results.download_links('image/' + csv_filename[18:-4])
